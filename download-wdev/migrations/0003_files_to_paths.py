...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Download.document'
        db.alter_column(u'download_download', 'document', self.gf('django.db.models.fields.files.FileField')(max_length=100))
    ...
    models = {
        ...
        u'download.download': {
            ...
            'document': ('django.db.models.fields.FilePathField', [], {'path': "'/Users/philtobias/Documents/UBNT/repos/ubntcom/ubntcom/ubntcom/downloads'", 'max_length': '100', 'recursive': 'True', 'match': "'.*\\\\.pdf$'"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
