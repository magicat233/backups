...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Download.document'
        db.alter_column(u'download_download', 'document', self.gf('django.db.models.fields.FilePathField')(path='/Users/philtobias/Documents/UBNT/repos/ubntcom/ubntcom/ubntcom/downloads', max_length=300, recursive=True, match='.*\\.pdf$'))

    def backwards(self, orm):

        # Changing field 'Download.document'
        db.alter_column(u'download_download', 'document', self.gf('django.db.models.fields.FilePathField')(path='/Users/philtobias/Documents/UBNT/repos/ubntcom/ubntcom/ubntcom/downloads', max_length=100, recursive=True, match='.*\\.pdf$'))
    ...
    models = {
        ...
        u'download.download': {
            ...
            'document': ('django.db.models.fields.FilePathField', [], {'path': "'/Users/philtobias/Documents/UBNT/repos/ubntcom/ubntcom/ubntcom/downloads'", 'max_length': '300', 'recursive': 'True', 'match': "'.*\\\\.pdf$'"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '150'}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['products.Product']"}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50'}),
            'thumbnail': ('django.db.models.fields.files.ImageField', [], {'max_length': '100'}),
            'thumbnail_retina': ('django.db.models.fields.files.ImageField', [], {'max_length': '100'})
        },
        ...
        u'products.productaccessory': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'family': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'+'", 'symmetrical': 'False', 'to': u"orm['products.ProductFamily']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
