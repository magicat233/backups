...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Download.document'
        db.delete_column(u'download_download', 'document')

        # Adding field 'Download.document_url'
        db.add_column(u'download_download', 'document_url',
                      self.gf('django.db.models.fields.URLField')(default=datetime.datetime(2014, 3, 21, 0, 0), max_length=300),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Download.document'
        db.add_column(u'download_download', 'document',
                      self.gf('django.db.models.fields.FilePathField')(default=datetime.datetime(2014, 3, 21, 0, 0), path='/Users/philtobias/Documents/UBNT/repos/ubntcom/ubntcom/ubntcom/downloads', max_length=300, recursive=True, match='.*\\.pdf$'),
                      keep_default=False)
