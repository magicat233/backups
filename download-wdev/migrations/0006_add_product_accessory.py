...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Download.product_accessory'
        #db.add_column(u'download_download', 'product_accessory',
        #              self.gf('django.db.models.fields.related.ForeignKey')(to=orm['products.ProductAccessory'], null=True, blank=True),
        #              keep_default=False)
        pass


    def backwards(self, orm):
        # Deleting field 'Download.product_accessory'
        #db.delete_column(u'download_download', 'product_accessory_id')
        pass
    ...
    models = {
        ...
        u'download.download': {
            ...
            'product': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['products.Product']", 'blank': 'True'}),
