...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Download.product'
        db.alter_column(u'download_download', 'product_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['products.Product'], null=True))

    def backwards(self, orm):

        # Changing field 'Download.product'
        db.alter_column(u'download_download', 'product_id', self.gf('django.db.models.fields.related.ForeignKey')(default=datetime.datetime(2014, 3, 21, 0, 0), to=orm['products.Product']))
