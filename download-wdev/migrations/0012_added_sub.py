...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DownloadSubscriber'
        db.create_table(u'download_downloadsubscriber', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=75)),
            ('product', self.gf('django.db.models.fields.CharField')(default='airmax', max_length=100)),
        ))
        db.send_create_signal(u'download', ['DownloadSubscriber'])


    def backwards(self, orm):
        # Deleting model 'DownloadSubscriber'
        db.delete_table(u'download_downloadsubscriber')
