...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Download.last_modified'
        db.add_column(u'download_download', 'last_modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 4, 18, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Download.last_modified'
        db.delete_column(u'download_download', 'last_modified')
