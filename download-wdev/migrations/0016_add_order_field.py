...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Download.thumbnail_retina'
        db.alter_column(u'download_download', 'thumbnail_retina', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Changing field 'Download.thumbnail'
        db.alter_column(u'download_download', 'thumbnail', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
        # Adding field 'DownloadCategory.order'
        db.add_column(u'download_downloadcategory', 'order',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Download.thumbnail_retina'
        db.alter_column(u'download_download', 'thumbnail_retina', self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100))

        # Changing field 'Download.thumbnail'
        db.alter_column(u'download_download', 'thumbnail', self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100))
        # Deleting field 'DownloadCategory.order'
        db.delete_column(u'download_downloadcategory', 'order')
    ...
    models = {
        ...
        u'products.productfeature': {
            ...
            'theme': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'feature_theme'", 'null': 'True', 'to': u"orm['products.ProductTheme']"}),
