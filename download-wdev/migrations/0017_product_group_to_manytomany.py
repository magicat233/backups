...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Download.product_group'
        db.delete_column(u'download_download', 'product_group_id')


        # Adding SortedM2M table for field product_group on 'Download'
        db.create_table(u'download_download_product_group', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('download', models.ForeignKey(orm[u'download.download'], null=False)),
            ('productgroup', models.ForeignKey(orm[u'products.productgroup'], null=False)),
            ('sort_value', models.IntegerField())
        ))
        db.create_unique(u'download_download_product_group', ['download_id', 'productgroup_id'])

    def backwards(self, orm):
        # Adding field 'Download.product_group'
        db.add_column(u'download_download', 'product_group',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['products.ProductGroup'], null=True, blank=True),
                      keep_default=False)

        # Removing M2M table for field product_group on 'Download'
        db.delete_table(db.shorten_name(u'download_download_product_group'))
