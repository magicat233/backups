...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Download.date_to_publish'
        db.add_column(u'download_download', 'date_to_publish',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Download.date_to_publish'
        db.delete_column(u'download_download', 'date_to_publish')
